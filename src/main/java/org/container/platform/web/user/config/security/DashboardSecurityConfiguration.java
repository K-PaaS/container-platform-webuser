package org.container.platform.web.user.config.security;

import org.container.platform.web.user.common.AuthService;
import org.container.platform.web.user.common.CommonUtils;
import org.container.platform.web.user.common.PropertyService;
import org.container.platform.web.user.common.RequestWrapper;
import org.container.platform.web.user.login.LoginService;
import org.container.platform.web.user.security.*;
import org.container.platform.web.user.users.UsersService;
...
public class DashboardSecurityConfiguration {
    ...
    @Autowired
    public DashboardAuthenticationProvider dashboardAuthenticationProvider(UsersService usersService, LoginService loginService, PropertyService propertyService) {
        return new DashboardAuthenticationProvider(usersService, loginService, propertyService);
    }
    ...
    public RequestMatcher dashboardLogoutUrlMatcher() {
        return new AntPathRequestMatcher("/sessionout");
    }
}
