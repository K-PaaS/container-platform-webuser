package org.container.platform.web.user.security;
...
//        String serviceInstanceId = "";
        ...
        String id = uaaUserInfo.get("sub");//ab130dde-d42e-43cc-a6d1-fd7153bfa3ce
        String userid = uaaUserInfo.get("preferred_username"); //username
        DashboardAuthenticationDetails authenticationDetails = new DashboardAuthenticationDetails(request, id, userid, getUserFullName(uaaUserInfo), this.restTemplate);
