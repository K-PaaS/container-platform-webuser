...
import static org.container.platform.web.user.config.security.DashboardSecurityConfiguration.isManagingApp;
...
public class ApplicationWebSecurityConfigurerAdapter extends WebSecurityConfigurerAdapter {
    ...
    public void configure(WebSecurity web) throws Exception {
        web.ignoring().antMatchers("/resources/**", "/sessionout", "/error/**","/common/error/**");
    }
