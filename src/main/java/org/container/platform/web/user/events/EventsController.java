package org.container.platform.web.user.events;
...
public class EventsController {
    ...
    @ResponseBody
    EventsList getEventsList(@PathVariable(value = "cluster") String cluster,
                             @PathVariable("namespace") String namespace,
                             @PathVariable("resourceUid") String resourceUid,
                             @RequestParam(value="type", required=false) String type,
                             @RequestParam(value="status", required=false) String status) {
        EventsList resultList = eventsService.getEventsList(cluster, namespace, resourceUid, type);
    ...
    @ResponseBody
    EventsList getNamespaceEventsList(@PathVariable(value = "cluster") String cluster,
                                      @PathVariable("namespace") String namespace) {
        return eventsService.getNamespaceEventsList(cluster, namespace);
    }
}
