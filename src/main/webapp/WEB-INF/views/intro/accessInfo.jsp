...
<script type="text/javascript">
    ...
    var callbackGetUser = function(data) {
        ...
        G_GUIDE_CLUSTER_NAME = data.cpClusterName;
        G_GUIDE_CLUSTER_SERVER = data.cpUrl;
        G_GUIDE_USER_NAME = data.serviceInstanceId + "-" + data.id;
        G_GUIDE_CONTEXT_NAME = G_GUIDE_USER_NAME + "-context";
        G_GUIDE_NAMESPACE = data.cpNamespace;
        ...
        G_USER_ACCESS_TOKEN = data.cpAccountTokenName;
        procViewLoading('hide');
        getAccessToken();
    };
    ...
    var getAccessToken = function () {
        procViewLoading('show');
        var reqUrl = "<%= Constants.CP_BASE_URL %><%= Constants.URI_API_SECRETS_DETAIL %>"
